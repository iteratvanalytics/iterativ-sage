...
function AuthPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col px-6 pt-20 pb-10 overflow-hidden">
      <div className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 w-[420px] h-[420px] rounded-full opacity-50 siri-orb" />
      <div className="relative flex-1 flex flex-col items-center justify-center">
        ...
        <p className="text-muted-foreground text-center mt-3 max-w-xs">
          An ambient AI agent that remembers, researches, and works in the background — across every conversation.
        </p>
